<?php
/**
 * Plugin Name: PDF Builder for Gravity
...
use rednaoformpdfbuilder\Integration\Adapters\Gravity\Loader\GravitySubLoader;

require_once plugin_dir_path(__FILE__).'autoload.php';
new GravitySubLoader(__FILE__,array(
    'ItemId'=>31,
    'Author'=>'Edgar Rojas',
    'UpdateURL'=>'https://pdfbuilder.rednao.com',
    'FileGroup'=>'PDFBuilderGravity'
));
